          ...
          <ul className="metismenu" id="menu">
            <li>
              ...
              <ul aria-expanded="false">
                ...
                <li><a href="/user-management">Kelola User</a></li>
                    ...
                    <div className="card-body">
                      <div className="media align-items-center">
                        ...
                        <div className="media-body">
                          <p className="fs-14 mb-2">Total Pengguna</p>
                          <span className="title text-black font-w600">45</span>
                        </div>
                      </div>
                      <div className="progress" style={{ height: '5px' }}>
                        <div className="progress-bar bg-success" style={{ width: '45%', height: '5px' }} aria-label="Progress-success" role="progressbar">
                  ...
                  <div className="card avtivity-card">
                    <div className="card-body">
                      <div className="media align-items-center">
                        ...
                        <div className="media-body">
                          <p className="fs-14 mb-2">Aktivitas Sistem</p>
                          <span className="title text-black font-w600">80%</span>
                        </div>
                      </div>
                      <div className="progress" style={{ height: '5px' }}>
                        <div className="progress-bar bg-secondary" style={{ width: '80%', height: '5px' }} aria-label="Progress-secondary" role="progressbar">
